 ...
 *
 *   // network
 *   CEplusCoinNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://www.ep-coin.com/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CEplusCoinNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CEplusCoinNetwork(UniValue objIn)
    {
...
// // can be under: EplusCoinNetwork
// //   -- signature requirements : Key1(User)
// class CEplusCoinNetworkVariable : public CGovernanceObject
// {
// private:
...
//     //     return (IsType() == EplusCoinNetwork);
//     // }
