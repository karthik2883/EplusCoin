...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "EplusCoinNetwork") type = EplusCoinNetwork;
    if(strType == "EplusCoinNetworkVariable") type = EplusCoinNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == EplusCoinNetwork) s = "EplusCoinNetwork";
    if(type == EplusCoinNetworkVariable) s = "EplusCoinNetworkVariable";
